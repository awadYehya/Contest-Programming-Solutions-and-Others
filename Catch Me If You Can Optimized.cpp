...
This is an edited version of my original catch me if you can code.

Instead of starting at the start point, I will move backwards from all possible
end locations to see if we can reach the starting position.
...
bool solveProblem_2(string start,d_stringmap & UniqueRoutes, stringmap & result) {
  
  // IDENTICAL TO solveProblem // 
  vector<string> modesList ;
  ...
  {
    notImpossible = takeRoute_2(start, modesList, UniqueRoutes, 0, result, kt->first) ;
  }
